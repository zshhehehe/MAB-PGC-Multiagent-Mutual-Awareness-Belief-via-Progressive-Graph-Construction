...
class RolloutWorker:
    ...
    def generate_episode(self, episode_num=None, evaluate=False):
        ...
        while not terminated and step < self.episode_limit:
            ...
            state = self.env.get_state()
            # obs = [state for i in range(self.n_agents)]
            actions, avail_actions, actions_onehot,xs = [], [], [],[]
            for agent_id in range(self.n_agents):
                ...
                if self.args.alg == 'maven':
                    ...
                    action,x = self.agents.choose_action(obs[agent_id], last_action[agent_id], agent_id,
            ...
            self.agents.policy.eval_query.updateKV(xs)
